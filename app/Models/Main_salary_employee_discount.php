...
class Main_salary_employee_discount extends Model
{
    use HasFactory;
    protected $table = "main_salary_employee_discounts";
    protected $guarded = [];
    ...
    public function employee(){
        return $this->BelongsTo('\App\Models\Employee', 'employee_code', 'employee_code');
    }
